			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{url('/all_post')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> Manage Post</span></a></li>
						<li><a href="{{url('/admin_post')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Post</span></a></li>
